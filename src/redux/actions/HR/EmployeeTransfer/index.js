...
export const getEmployeeTransfer = (params) => {
  return async (dispatch) => {
    await axios.post(apiEndPoints.getEmployeeTransferList, params, getHeaders).then(
      (response) => {
...
export const getEmployeeTransferById = (params) => {
  return async (dispatch) => {
    await axios.post(apiEndPoints.getEmployeeTransferById, params, getHeaders).then(
      (response) => {
        if (response.data.Status !== 1 && response.data.ErrorMessage) {
          dispatch({
...
export const getEmployeeTransferAttachment = (params) => {
  return async (dispatch) => {
    await axios
      .post(apiEndPoints.getEmployeeTransferAttachment, params, getHeaders)
      .then(
        (response) => {
          if (response.data.Status !== 1 && response.data.ErrorMessage) {
            dispatch({
...
export const addEmployeeTransferAttchment = (obj) => {
  return (dispatch, getState) => {
    let params = getState().employeeTransfer.params;
    ...
    axios
      .post(apiEndPoints.addEmployeeTransferAttchment, formData, getHeaders)
      .then((response) => {
        if (response.data.Status !== 1 && response.data.ErrorMessage) {
          dispatch({
